...
void final_scene(const char* filenamein, const char* filenameout) {
...
int main(int argc, char * argv[]) {
    switch(argv[1][0]) {
        ...
        case '7': cornell_box(argv[2]); break;
        case '8': cornell_smoke(argv[2]); break;
        case '9': final_scene(argv[2], argv[3]); break;
    }
}